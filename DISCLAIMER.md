# Disclaimer & Acceptable Use — insane-review

`insane-review` is part of the [gptaku-plugins](https://github.com/fivetaku/gptaku_plugins)
...
`insane-review` is a general-purpose developer tool. Like most general-purpose tools, it
